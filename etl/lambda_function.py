...
def handler(event, context):
    ...
    cluster_id = client.run_job_flow(
                ...
                Instances={
                    ...
                    'Ec2KeyName': 'igti-atheobaldo-key-pair',   # Criar key pair em EC2 manualmente e colar aqui
                    'KeepJobFlowAliveWhenNoSteps': True,
                    'TerminationProtected': False,
                    'Ec2SubnetId': 'subnet-05c71871d62eb9920'        # recuperar subnet id da região us-east-2 manualmente e colar aqui
                },
